...
# from TRAIN_vrcnn import BATCH_SIZE
# from TRAIN_vrcnn import PATCH_SIZE
...
def get_train_list(lowList, highList, min ,max):
    print("len(lowList)",len(lowList))
    print("len(highList)",len(highList))
