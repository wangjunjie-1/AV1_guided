#copy from cnn_CRLC_vrcnn_v2.py  nothing change 2021.8.15
import sys
...
quantSet = {
    "range16": {
        "VRCNN_V4_QP6~15": (1024, 0, -7),
        "VRCNN_V4_QP16~25": (512, 0, 0),
        "VRCNN_V4_QP26~30": (2048, -2, -1),
        "VRCNN_V4_QP31~35": (128, -8, 2),#vrcnn ok
        "VRCNN_V4_QP36~45": (128, 2, -11),#vrcnn ok
        "VRCNN_V4_QP46~55": (128, -5, -25),#vrcnn ok
        "VRCNN_V4_QP56~63": (128, -10, -18)#vrcnn ok
    },
}
